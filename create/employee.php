...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    do {
        ...
        $sql = "INSERT INTO employee(name,email,phone,division,cader,post,postin,postout,address,education)" .
            "VALUES ('$name', '$email', '$phone', '$division', '$cader', '$post', '$postin', '$postout', '$address', '$education')";
